...
namespace ERP.Domain.Sales
{
    ...
    public class TransportDetail
    {
        ...
        public ICollection<TransportAttachment> Attachments { get; set; } = new List<TransportAttachment>();

        public ICollection<TransportTimelineEvent> Timeline { get; set; } = new List<TransportTimelineEvent>();
    }
    ...
    public class TransportAttachment
    {
        ...
        public TransportDetail TransportDetail { get; set; } = null!;
    ...
    public class TransportTimelineEvent
    {
        public int Id { get; set; }
